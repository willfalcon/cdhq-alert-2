...
add_action( 'tgmpa_register', 'cdhqa_register_required_plugins' );

function cdhqa_register_required_plugins() {
  /*
  ...
  $config = array(
		'id'           => 'cdhqa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
